...
% fmap = spm_select([1 Inf], 'image', 'Select the fieldmaps Directory',...
%                       {}, toolboxFileLoc, '.*', 1);
...
% 
% inpt = [fullfile(toolboxFileLoc,'Fieldmaps') filesep];
% 
...
% Scan_param = SetDefaultScannerParam;
% if isnumeric( Scan_param.T2s) 
%     t2map = Scan_param.T2s;
% else
%     inpt = [fullfile(toolboxFileLoc)];
%     t2map = [inpt char(Scan_param.T2s)];
% end
% 
% % -----------------------------------------------------------------------
% % T2* Value
% % -----------------------------------------------------------------------
% T2svalue         = cfg_entry;
% T2svalue.tag     = 'T2svalue';
% T2svalue.name    = 'T2s Value';
% T2svalue.val     = {t2map};
% T2svalue.help    = {'T2star value in ms'};
% 
% % -----------------------------------------------------------------------
% % Other Settings
% % -----------------------------------------------------------------------
...
opt_results = epi_opt_param_TB(job.inputfiles.fieldmaps, ...
                               job.inputfiles.rois, ...
